    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-emerald-50 to-white border-b border-emerald-100 py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div
            className="text-5xl mb-4 animate-fade-slide-up"
            style={{ animationDelay: '0ms' }}
          >
            🛋️
          </div>
          <h1
            className="text-4xl md:text-5xl font-bold text-gray-900 mb-1 animate-fade-slide-up"
          ...
          <div
            className="mb-3 animate-fade-slide-up"
          ...
          <p
            className="text-gray-500 mb-8 text-sm animate-fade-slide-up"
          ...
          >
            <Link
              href="/giveaways"
              className="inline-flex items-center gap-2 bg-emerald-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-emerald-700 hover:scale-[1.03] active:scale-[0.98] transition-all"
            >
              <Gift size={18} />
      ...
      <section className="max-w-6xl mx-auto px-4 py-14 grid md:grid-cols-2 gap-8">
        <AnimateOnScroll delay={0}>
          <Link href="/giveaways" className="group bg-emerald-50 border-2 border-emerald-200 rounded-2xl p-8 hover:border-emerald-400 hover:shadow-md transition-all block">
        ...
        <AnimateOnScroll delay={100}>
          <Link href="/sales" className="group bg-blue-50 border-2 border-blue-200 rounded-2xl p-8 hover:border-blue-400 hover:shadow-md transition-all block">
      ...
      <section className="bg-white border-t border-gray-100 py-14 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            {[
              { emoji: '📸', title: 'Post with photos', body: 'Upload 2–3 photos, describe your item, and set your price (or mark it free).' },
              { emoji: '📍', title: 'Reach your community', body: 'Listings are filtered by area so neighbors find exactly what they need.' },
              { emoji: '🤝', title: 'Connect directly', body: 'Interested families contact you directly. No middleman, no fees for buyers.' },
            ].map((item, i) => (
      ...
      <AnimateOnScroll>
        <section className="bg-emerald-700 text-white py-14 px-4 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-emerald-200 text-xs mt-3">Giveaway listings: Free · For-sale listings: $10</p>
          </div>
        </section>
      </AnimateOnScroll>
